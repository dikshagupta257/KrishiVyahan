...
import com.codingblocksmodules.agrome.databinding.ActivitySellerBinding
...
class
SellerActivity : AppCompatActivity() {
    ...
    //util function to send the number of logged in user to other fragments
    fun getData():String {
